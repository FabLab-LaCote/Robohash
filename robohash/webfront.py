...
"""                                        ()               ()
        ...
        drquotes = [("Eliminates sources of Human Error.", "Dr. Chandra, RobotCrunch"),
                    ...
                    ("It looks highly profitable, I'm sure..",
                     "Dr. R. Venture, Super Scientist. Available for parties."),
        ...
        self.write(self.render_string('templates/root.html', ip=ip, robo=random.choice(robo), drquote1=drquotes[1],
                                      drquote2=drquotes[2], quotes=quotes))
